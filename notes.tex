...
\label{sec:org76ad48a}
\subsubsection{About affine maps}
\label{sec:org5e075c9}
...
\label{sec:orgbe6b7bf}
\subsubsection{Lemma}
\label{sec:orgf8e8074}
...
\label{sec:org2260a1f}
\(y = x^2\) is a convex function.
\subsubsection{{\bfseries\sffamily TODO} Proof}
\label{sec:org66a287c}
\(\implies f\) is convex
