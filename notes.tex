...
\label{sec:orga987204}
\subsubsection{About affine maps}
\label{sec:orgb1b7334}
...
\label{sec:org14953a4}
\subsection{Review}
\label{sec:org18a829e}
\subsubsection{Radon's theorem}
\label{sec:orgdabd9da}
\begin{enumerate}
...
\label{sec:org55ef705}
\subsubsection{Lemma}
\label{sec:org66a4fc1}
...
\label{sec:orgbc31ba7}
\subsection{Review}
\label{sec:orgaed00a9}
\subsubsection{Nearest point map}
\label{sec:org45d4014}
...
\label{sec:org715a7b6}
\subsubsection{Definition}
\label{sec:org385a437}
...
\label{sec:org777ccc0}
\subsection{Review}
\label{sec:orga4fecbb}
...
\label{sec:org74cfc06}
\(y = x^2\) is a convex function.
\subsubsection{{\bfseries\sffamily TODO} Proof}
\label{sec:orgc4d3db4}
\(\implies f\) is convex
...
\label{sec:org14c5854}
\subsection{Polar Body}
\label{sec:orgbfa29e4}
...
\label{sec:org301e7c7}
\subsection{Helly's theorem}
\label{sec:org180945a}
Let \(K_1, \cdots, K_n\) be a collection of convex sets in \(\R^d\) such that
every subcollection of \(d+1\) of them intersects \(\neq \emptyset\), then the
complete family intersects.
\subsubsection{Is convexity important?}
\label{sec:org6b4ea74}
...
\label{sec:orgd7e0671}
\subsection{Lemma about convex functions}
\label{sec:org059b57f}
...
\label{sec:org9b61048}
\subsection{Partially Ordered sets}
\label{sec:org2818bca}
